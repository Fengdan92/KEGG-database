...
random.seed()
#print "go6 run number " + str(runNumber) + " has random seed: " + str(rndseed)

file1 = open('/scratch/fy9/go6/lst_reactions_go6.pkl', 'rb')
lst_reactions = pickle.load(file1)
file1.close()

file2 = open('/scratch/fy9/go6/lst_metabolites_go6.pkl', 'rb')
lst_metabolites = pickle.load(file2)
file2.close()

file3 = open('/scratch/fy9/go6/edges_go6.pkl', 'rb')
...
print "go6 run number " + str(runNumber) + " has maximum modularity: " + str(maxM)
# this will show up in the .out files in /scratch/fy9/run folder

# Print community strcuture
filename = '/scratch/fy9/go6/commStruc_go6_run' + runNumber + '.pkl'
...
for key, value in s.items():
    for node in value:	
        partition[node]=key
filename = '/scratch/fy9/go6/partition_go6_run' + runNumber + '.pkl'
file = open(filename, 'wb')
...
filename = '/scratch/fy9/go6/cocluster_go6_run' + runNumber + '.pkl'
file = open(filename, 'wb')
