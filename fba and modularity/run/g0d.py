...
random.seed()
#print "g0d run number " + str(runNumber) + " has random seed: " + str(rndseed)

file1 = open('/scratch/fy9/g0d/lst_reactions_g0d.pkl', 'rb')
lst_reactions = pickle.load(file1)
file1.close()

file2 = open('/scratch/fy9/g0d/lst_metabolites_g0d.pkl', 'rb')
lst_metabolites = pickle.load(file2)
file2.close()

file3 = open('/scratch/fy9/g0d/edges_g0d.pkl', 'rb')
...
print "g0d run number " + str(runNumber) + " has maximum modularity: " + str(maxM)
# this will show up in the .out files in /scratch/fy9/run folder

# Print community strcuture
filename = '/scratch/fy9/g0d/commStruc_g0d_run' + runNumber + '.pkl'
...
for key, value in s.items():
    for node in value:	
        partition[node]=key
filename = '/scratch/fy9/g0d/partition_g0d_run' + runNumber + '.pkl'
file = open(filename, 'wb')
...
filename = '/scratch/fy9/g0d/cocluster_g0d_run' + runNumber + '.pkl'
file = open(filename, 'wb')
