...
random.seed()
#print "g0 run number " + str(runNumber) + " has random seed: " + str(rndseed)

file1 = open('/scratch/fy9/g0/lst_reactions_g0.pkl', 'rb')
lst_reactions = pickle.load(file1)
file1.close()

file2 = open('/scratch/fy9/g0/lst_metabolites_g0.pkl', 'rb')
lst_metabolites = pickle.load(file2)
file2.close()

file3 = open('/scratch/fy9/g0/edges_g0.pkl', 'rb')
...
print "g0 run number " + str(runNumber) + " has maximum modularity: " + str(maxM)
# this will show up in the .out files in /scratch/fy9/run folder

# Print community strcuture
filename = '/scratch/fy9/g0/commStruc_g0_run' + runNumber + '.pkl'
...
for key, value in s.items():
    for node in value:	
        partition[node]=key
filename = '/scratch/fy9/g0/partition_g0_run' + runNumber + '.pkl'
file = open(filename, 'wb')
...
filename = '/scratch/fy9/g0/cocluster_g0_run' + runNumber + '.pkl'
file = open(filename, 'wb')
