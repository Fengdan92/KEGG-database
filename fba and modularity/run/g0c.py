...
random.seed()
#print "g0c run number " + str(runNumber) + " has random seed: " + str(rndseed)

file1 = open('/scratch/fy9/g0c/lst_reactions_g0c.pkl', 'rb')
lst_reactions = pickle.load(file1)
file1.close()

file2 = open('/scratch/fy9/g0c/lst_metabolites_g0c.pkl', 'rb')
lst_metabolites = pickle.load(file2)
file2.close()

file3 = open('/scratch/fy9/g0c/edges_g0c.pkl', 'rb')
...
print "g0c run number " + str(runNumber) + " has maximum modularity: " + str(maxM)
# this will show up in the .out files in /scratch/fy9/run folder

# Print community strcuture
filename = '/scratch/fy9/g0c/commStruc_g0c_run' + runNumber + '.pkl'
...
for key, value in s.items():
    for node in value:	
        partition[node]=key
filename = '/scratch/fy9/g0c/partition_g0c_run' + runNumber + '.pkl'
file = open(filename, 'wb')
...
filename = '/scratch/fy9/g0c/cocluster_g0c_run' + runNumber + '.pkl'
file = open(filename, 'wb')
