...
random.seed()
#print "g0b run number " + str(runNumber) + " has random seed: " + str(rndseed)

file1 = open('/scratch/fy9/g0b/lst_reactions_g0b.pkl', 'rb')
lst_reactions = pickle.load(file1)
file1.close()

file2 = open('/scratch/fy9/g0b/lst_metabolites_g0b.pkl', 'rb')
lst_metabolites = pickle.load(file2)
file2.close()

file3 = open('/scratch/fy9/g0b/edges_g0b.pkl', 'rb')
...
print "g0b run number " + str(runNumber) + " has maximum modularity: " + str(maxM)
# this will show up in the .out files in /scratch/fy9/run folder

# Print community strcuture
filename = '/scratch/fy9/g0b/commStruc_g0b_run' + runNumber + '.pkl'
...
for key, value in s.items():
    for node in value:	
        partition[node]=key
filename = '/scratch/fy9/g0b/partition_g0b_run' + runNumber + '.pkl'
file = open(filename, 'wb')
...
filename = '/scratch/fy9/g0b/cocluster_g0b_run' + runNumber + '.pkl'
file = open(filename, 'wb')
