...
random.seed()
#print "g0g run number " + str(runNumber) + " has random seed: " + str(rndseed)

file1 = open('/scratch/fy9/g0g/lst_reactions_g0g.pkl', 'rb')
lst_reactions = pickle.load(file1)
file1.close()

file2 = open('/scratch/fy9/g0g/lst_metabolites_g0g.pkl', 'rb')
lst_metabolites = pickle.load(file2)
file2.close()

file3 = open('/scratch/fy9/g0g/edges_g0g.pkl', 'rb')
...
print "g0g run number " + str(runNumber) + " has maximum modularity: " + str(maxM)
# this will show up in the .out files in /scratch/fy9/run folder

# Print community strcuture
filename = '/scratch/fy9/g0g/commStruc_g0g_run' + runNumber + '.pkl'
...
for key, value in s.items():
    for node in value:	
        partition[node]=key
filename = '/scratch/fy9/g0g/partition_g0g_run' + runNumber + '.pkl'
file = open(filename, 'wb')
...
filename = '/scratch/fy9/g0g/cocluster_g0g_run' + runNumber + '.pkl'
file = open(filename, 'wb')
