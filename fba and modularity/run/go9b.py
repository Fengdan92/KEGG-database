...
random.seed()
#print "go9b run number " + str(runNumber) + " has random seed: " + str(rndseed)

file1 = open('/scratch/fy9/go9b/lst_reactions_go9b.pkl', 'rb')
lst_reactions = pickle.load(file1)
file1.close()

file2 = open('/scratch/fy9/go9b/lst_metabolites_go9b.pkl', 'rb')
lst_metabolites = pickle.load(file2)
file2.close()

file3 = open('/scratch/fy9/go9b/edges_go9b.pkl', 'rb')
...
print "go9b run number " + str(runNumber) + " has maximum modularity: " + str(maxM)
# this will show up in the .out files in /scratch/fy9/run folder

# Print community strcuture
filename = '/scratch/fy9/go9b/commStruc_go9b_run' + runNumber + '.pkl'
...
for key, value in s.items():
    for node in value:	
        partition[node]=key
filename = '/scratch/fy9/go9b/partition_go9b_run' + runNumber + '.pkl'
file = open(filename, 'wb')
...
filename = '/scratch/fy9/go9b/cocluster_go9b_run' + runNumber + '.pkl'
file = open(filename, 'wb')
