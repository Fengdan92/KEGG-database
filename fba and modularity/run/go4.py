...
random.seed()
#print "go4 run number " + str(runNumber) + " has random seed: " + str(rndseed)

file1 = open('/scratch/fy9/go4/lst_reactions_go4.pkl', 'rb')
lst_reactions = pickle.load(file1)
file1.close()

file2 = open('/scratch/fy9/go4/lst_metabolites_go4.pkl', 'rb')
lst_metabolites = pickle.load(file2)
file2.close()

file3 = open('/scratch/fy9/go4/edges_go4.pkl', 'rb')
...
print "go4 run number " + str(runNumber) + " has maximum modularity: " + str(maxM)
# this will show up in the .out files in /scratch/fy9/run folder

# Print community strcuture
filename = '/scratch/fy9/go4/commStruc_go4_run' + runNumber + '.pkl'
...
for key, value in s.items():
    for node in value:	
        partition[node]=key
filename = '/scratch/fy9/go4/partition_go4_run' + runNumber + '.pkl'
file = open(filename, 'wb')
...
filename = '/scratch/fy9/go4/cocluster_go4_run' + runNumber + '.pkl'
file = open(filename, 'wb')
